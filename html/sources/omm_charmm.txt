...
<chemistry.charmm.CharmmParameterSet>` with the parameters we wish to use. In
...
We also define the :class:`CharmmPsfFile <chemistry.charmm.CharmmParameterSet>`
...
See the API documentation for the ``chemistry`` package for a full listing of
...
:class:`CharmmCrdFile <chemistry.charmm.CharmmCrdFile>` or
:class:`CharmmRstFile <chemistry.charmm.CharmmRstFile>` (restart file) instead.
...
We also define the :class:`CharmmPsfFile <chemistry.charmm.CharmmPsfFile>`
...
See the API documentation for the :mod:`chemistry` package for a full listing
...
This stage defines reporters that will "report" on the status of the simulation
periodically throughout the simulation. The first is an
:class:`StateDataReporter <chemistry.openmm.StateDataReporter>` which will print
out a summary of energies and temperatures every 100 steps. Unlike the
:class:`StateDataReporter <chemistry.openmm.StateDataReporter>` in OpenMM, this

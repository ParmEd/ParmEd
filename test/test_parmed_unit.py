...
class TestUnits(QuantityTestCase):
    ...
    def testUnitSystem(self):
        ...
        self.assertEqual(
            us.express_unit(u.meter / u.second), u.meter / u.second)
    ...
    def testToBaseUnit(self):
        ...
        self.assertEqual(
            u.calorie.get_conversion_factor_to_base_units(), 4.184)
    ...
    def testQuantityMaths(self):
        ...
        self.assertAlmostEqual(
            (d2 + d1 - (2e9 + 2) * u.nanometers)._value, 0, places=6)
        ...
        self.assertAlmostEqual(
            1.5 * u.nanometers / u.meters, 1.5e-9, places=15)
    ...
    def testQuantityComplicatedMaths(self):
        ...
        self.assertEqual(
            u1**(1 / x1), u.kilogram**0.5 * u.meter**0.5 / u.second)
    ...
    def testChemistryProblems(self):
        ...
        self.assertAlmostEqualQuantities(
            P * V, val * u.atmospheres * u.meters**3)
    ...
    def testQuantityCollectionMethods(self):
        ...
        if not utils.openmm_version or utils.openmm_version > (6, 2):
            ...
            self.assertAlmostEqualQuantities(
                seq.std(), 1.1180339887498949 * u.meters)
    ...
    def testMisc(self):
        ...
        self.assertEqual(
            repr(1.2 * u.meters), 'Quantity(value=1.2, unit=meter)')
...
class TestNumpyUnits(QuantityTestCase):
    ...
    def testNumpyDivision(self):
        ...
        self.assertEqual(
            xy[0].value_in_unit(u.nanometers / u.picoseconds), 1 / 3)
        self.assertEqual(
    ...
    def testNumpyFunctions(self):
        ...
        self.assertAlmostEqualQuantities(
            a.std(), 2.8722813232690143 * u.seconds)
        b = a.reshape((5, 2))

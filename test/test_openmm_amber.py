...
# 6514.3661
        ...
        pf = pstate.getForces().value_in_unit(
            u.kilocalorie_per_mole / u.angstrom)
        sf = sstate.getForces().value_in_unit(
            u.kilocalorie_per_mole / u.angstrom)
    ...
    def testRoundTripEP(self):
        ...
        f1 = state1.getForces().value_in_unit(
            u.kilocalorie_per_mole / u.angstrom)
        f2 = state2.getForces().value_in_unit(
            u.kilocalorie_per_mole / u.angstrom)
...
# BOND   =         5.4435  ANGLE   =         2.8766  DIHED      =        24.3697
# 1-4 NB =         6.1446  1-4 EEL =        20.8049  VDWAALS    =        44.3715
# EELEC  =      -101.5565  EGB     =       -26.4850  RESTRAINT  =
# 0.0000
        self.assertRelativeEqual(energies['bond'], 5.4435, places=4)
        self.assertRelativeEqual(energies['angle'], 2.8766, places=4)
        self.assertRelativeEqual(energies['dihedral'], 24.3697, places=4)
...
# BOND   =         5.4435  ANGLE   =         2.8766  DIHED      =        24.3697
# 1-4 NB =         6.1446  1-4 EEL =        20.8049  VDWAALS    =        44.3715
# EELEC  =      -101.5565  EGB     =       -26.5051  RESTRAINT  =
# 0.0000
        self.assertRelativeEqual(energies['bond'], 5.4435, places=4)
        self.assertRelativeEqual(energies['angle'], 2.8766, places=4)
        self.assertRelativeEqual(energies['dihedral'], 24.3697, places=4)
...
# BOND   =         5.4435  ANGLE   =         2.8766  DIHED      =        24.3697
# 1-4 NB =         6.1446  1-4 EEL =        20.8049  VDWAALS    =        44.3715
# EELEC  =      -101.5565  EGB     =       -28.1689  RESTRAINT  =
# 0.0000
        self.assertRelativeEqual(energies['bond'], 5.4435, places=4)
        self.assertRelativeEqual(energies['angle'], 2.8766, places=4)
        self.assertRelativeEqual(energies['dihedral'], 24.3697, places=4)
...
# BOND   =         5.4435  ANGLE   =         2.8766  DIHED      =        24.3697
# 1-4 NB =         6.1446  1-4 EEL =        20.8049  VDWAALS    =        44.3715
# EELEC  =      -101.5565  EGB     =       -28.1895  RESTRAINT  =
# 0.0000
        self.assertRelativeEqual(energies['bond'], 5.4435, places=4)
        self.assertRelativeEqual(energies['angle'], 2.8766, places=4)
        self.assertRelativeEqual(energies['dihedral'], 24.3697, places=4)
...
# BOND   =         5.4435  ANGLE   =         2.8766  DIHED      =        24.3697
# 1-4 NB =         6.1446  1-4 EEL =        20.8049  VDWAALS    =        44.3715
# EELEC  =      -101.5565  EGB     =       -28.4639  RESTRAINT  =
# 0.0000
        self.assertRelativeEqual(energies['bond'], 5.4435, places=4)
        self.assertRelativeEqual(energies['angle'], 2.8766, places=4)
        self.assertRelativeEqual(energies['dihedral'], 24.3697, places=4)
...
# BOND   =         5.4435  ANGLE   =         2.8766  DIHED      =        24.3697
# 1-4 NB =         6.1446  1-4 EEL =        20.8049  VDWAALS    =        44.3715
# EELEC  =      -101.5565  EGB     =       -25.4835  RESTRAINT  =
# 0.0000
        self.assertRelativeEqual(energies['bond'], 5.4435, places=4)
        self.assertRelativeEqual(energies['angle'], 2.8766, places=4)
        self.assertRelativeEqual(energies['dihedral'], 24.3697, places=4)
    ...
    def testGB7Energy(self):  # GBn (igb=7)
        ...
        # Load crds into copy
        PT.loadRestrt(parm, get_fn('ash.rst7')).execute()
...
# BOND   =         5.4435  ANGLE   =         2.8766  DIHED      =        24.3697
# 1-4 NB =         6.1446  1-4 EEL =        20.8049  VDWAALS    =        44.3715
# EELEC  =      -101.5565  EGB     =       -21.1012  RESTRAINT  =
# 0.0000
        self.assertRelativeEqual(energies['bond'], 5.4435, places=4)
        self.assertRelativeEqual(energies['angle'], 2.8766, places=4)
        self.assertRelativeEqual(energies['dihedral'], 24.3697, places=4)
...
# BOND   =         5.4435  ANGLE   =         2.8766  DIHED      =        24.3697
# 1-4 NB =         6.1446  1-4 EEL =        20.8049  VDWAALS    =        44.3715
# EELEC  =      -101.5565  EGB     =       -21.1194  RESTRAINT  =
# 0.0000
        self.assertRelativeEqual(energies['bond'], 5.4435, places=4)
        self.assertRelativeEqual(energies['angle'], 2.8766, places=4)
        self.assertRelativeEqual(energies['dihedral'], 24.3697, places=4)
...
# BOND   =         5.4435  ANGLE   =         2.8766  DIHED      =        24.3697
# 1-4 NB =         6.1446  1-4 EEL =        20.8049  VDWAALS    =        44.3715
# EELEC  =      -101.5565  EGB     =       -23.4639  RESTRAINT  =
# 0.0000
        self.assertRelativeEqual(energies['bond'], 5.4435, places=4)
        self.assertRelativeEqual(energies['angle'], 2.8766, places=4)
        self.assertRelativeEqual(energies['dihedral'], 24.3697, places=4)
...
# BOND   =         5.4435  ANGLE   =         2.8766  DIHED      =        24.3697
# 1-4 NB =         6.1446  1-4 EEL =        20.8049  VDWAALS    =        44.3715
# EELEC  =      -101.5565  EGB     =       -23.4832  RESTRAINT  =
# 0.0000
        self.assertRelativeEqual(energies['bond'], 5.4435, places=4)
        self.assertRelativeEqual(energies['angle'], 2.8766, places=4)
        self.assertRelativeEqual(energies['dihedral'], 24.3697, places=4)
...
# Ewald error estimate:   0.8352E-05
    ...
    def testSHAKE(self):
        ...
        state = sim.context.getState(getEnergy=True, enforcePeriodicBox=True,
                                     groups=2**parm.BOND_FORCE_GROUP)
        bond = state.getPotentialEnergy().value_in_unit(
...
#                                                   Density    =         0.6634
    ...
    def test1012(self):
        ...
        self.assertRelativeEqual(
            energies['nonbond'], -11191.2563220, delta=3e-5)
...
# UB     =         0.3669  IMP     =         0.3344  CMAP       =        -0.5239
# 1-4 NB =         2.1041  1-4 EEL =       278.1614  VDWAALS    =        -1.3323
# EELEC  =      -269.7122  EGB     =      -113.2014  RESTRAINT  =
# 0.0000
        self.assertAlmostEqual(energies['bond'], 1.3351, delta=5e-4)
        self.assertAlmostEqual(energies['angle'], 14.1158, delta=5e-4)
        self.assertAlmostEqual(energies['urey'], 0.3669, delta=5e-4)
...
# UB     =         0.3669  IMP     =         0.3344  CMAP       =        -0.5239
# 1-4 NB =         2.1041  1-4 EEL =       278.1614  VDWAALS    =        -1.3323
# EELEC  =      -269.7122  EGB     =      -113.5439  RESTRAINT  =
# 0.0000
        self.assertAlmostEqual(energies['bond'], 1.3351, delta=5e-4)
        self.assertAlmostEqual(energies['angle'], 14.1158, delta=5e-4)
        self.assertAlmostEqual(energies['urey'], 0.3669, delta=5e-4)
...
# UB     =         0.3669  IMP     =         0.3344  CMAP       =        -0.5239
# 1-4 NB =         2.1041  1-4 EEL =       278.1614  VDWAALS    =        -1.3323
# EELEC  =      -269.7122  EGB     =      -117.0885  RESTRAINT  =
# 0.0000
        self.assertAlmostEqual(energies['bond'], 1.3351, delta=5e-4)
        self.assertAlmostEqual(energies['angle'], 14.1158, delta=5e-4)
        self.assertAlmostEqual(energies['urey'], 0.3669, delta=5e-4)
...
# UB     =         0.3669  IMP     =         0.3344  CMAP       =        -0.5239
# 1-4 NB =         2.1041  1-4 EEL =       278.1614  VDWAALS    =        -1.3323
# EELEC  =      -269.7122  EGB     =      -117.4339  RESTRAINT  =
# 0.0000
        self.assertAlmostEqual(energies['bond'], 1.3351, delta=5e-4)
        self.assertAlmostEqual(energies['angle'], 14.1158, delta=5e-4)
        self.assertAlmostEqual(energies['urey'], 0.3669, delta=5e-4)
...
# UB     =         0.3669  IMP     =         0.3344  CMAP       =        -0.5239
# 1-4 NB =         2.1041  1-4 EEL =       278.1614  VDWAALS    =        -1.3323
# EELEC  =      -269.7122  EGB     =      -112.8396  RESTRAINT  =
# 0.0000
        self.assertAlmostEqual(energies['bond'], 1.3351, delta=5e-4)
        self.assertAlmostEqual(energies['angle'], 14.1158, delta=5e-4)
        self.assertAlmostEqual(energies['urey'], 0.3669, delta=5e-4)
...
# UB     =         0.3669  IMP     =         0.3344  CMAP       =        -0.5239
# 1-4 NB =         2.1041  1-4 EEL =       278.1614  VDWAALS    =        -1.3323
# EELEC  =      -269.7122  EGB     =      -113.1813  RESTRAINT  =
# 0.0000
        self.assertAlmostEqual(energies['bond'], 1.3351, delta=5e-4)
        self.assertAlmostEqual(energies['angle'], 14.1158, delta=5e-4)
        self.assertAlmostEqual(energies['urey'], 0.3669, delta=5e-4)
...
# UB     =         0.3669  IMP     =         0.3344  CMAP       =        -0.5239
# 1-4 NB =         2.1041  1-4 EEL =       278.1614  VDWAALS    =        -1.3323
# EELEC  =      -269.7122  EGB     =      -114.1816  RESTRAINT  =
# 0.0000
        self.assertAlmostEqual(energies['bond'], 1.3351, delta=5e-4)
        self.assertAlmostEqual(energies['angle'], 14.1158, delta=5e-4)
        self.assertAlmostEqual(energies['urey'], 0.3669, delta=5e-4)
...
# UB     =         0.3669  IMP     =         0.3344  CMAP       =        -0.5239
# 1-4 NB =         2.1041  1-4 EEL =       278.1614  VDWAALS    =        -1.3323
# EELEC  =      -269.7122  EGB     =      -114.5251  RESTRAINT  =
# 0.0000
        self.assertAlmostEqual(energies['bond'], 1.3351, delta=5e-4)
        self.assertAlmostEqual(energies['angle'], 14.1158, delta=5e-4)
        self.assertAlmostEqual(energies['urey'], 0.3669, delta=5e-4)
...
# UB     =         0.3669  IMP     =         0.3344  CMAP       =        -0.5239
# 1-4 NB =         2.1041  1-4 EEL =       278.1614  VDWAALS    =        -1.3323
# EELEC  =      -269.7122  EGB     =      -117.3606  RESTRAINT  =
# 0.0000
        self.assertAlmostEqual(energies['bond'], 1.3351, delta=5e-4)
        self.assertAlmostEqual(energies['angle'], 14.1158, delta=5e-4)
        self.assertAlmostEqual(energies['urey'], 0.3669, delta=5e-4)
...
# UB     =         0.3669  IMP     =         0.3344  CMAP       =        -0.5239
# 1-4 NB =         2.1041  1-4 EEL =       278.1614  VDWAALS    =        -1.3323
# EELEC  =      -269.7122  EGB     =      -117.7068  RESTRAINT  =
# 0.0000
        self.assertAlmostEqual(energies['bond'], 1.3351, delta=5e-4)
        self.assertAlmostEqual(energies['angle'], 14.1158, delta=5e-4)
        self.assertAlmostEqual(energies['urey'], 0.3669, delta=5e-4)

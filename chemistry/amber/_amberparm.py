...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   def __init__(self, prm_name=None, rst7_name=None):
      ...
      validity based on presence of POINTERS and CHARGE sections.
      """
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   def load_from_rawdata(cls, rawdata):
      ...
      @param rawdata AmberFormat that has already parsed a file

      @returns populated AmberParm object
      """
      inst = cls()
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   def ToMolecule(self):
      ...
      elements = [periodic_table.Element[atm.atomic_number] for atm in self.atom_list]
...
class Rst7(object):
   ...
   def __init__(self, filename=None, natom=None, title='', hasvels=False,
      ...
      if filename is not None:
         warn('Use Rst7.open() constructor instead of default constructor to '
              'parse restart files.', DeprecationWarning)
         self._read(filename)
      ...
      try:
         ...
         try:
            ...
            raise ReadError('Could not parse %s as an ASCII restart and '
                     'could not find any NetCDF-Python packages to attempt '
                     'to parse as a NetCDF Restart.' % filename)
         except RuntimeError:

        ...
        for atom in self.residues[residue_name].atoms:
            ...
            for bond in self.residues[residue_name].bonds:
                ...
                if (bond.atom1.name == 'OD1' and bond.atom2 == atom) or (bond.atom1 == atom and bond.atom2.name == 'OD1'):
                    if residue_name in ['OLP', 'NOLP', 'COLP']:
                        pass
                    else:
                        bonds += 1
            ...
            # If the number of bonds within the residue is greater than the number of bonds the atom should have, the atom  has an external bond 

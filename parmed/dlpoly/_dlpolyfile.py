"""
Provides a class for reading DLPOLY-style files. The key component to these
files is that the ; character is a comment character and everything after ; is
ignored.
"""
from __future__ import division, print_function, absolute_import

from parmed.dlpoly._cpp import CPreProcessor

class DlpolyFile(object):
    """
    A DLPOLY file that recognizes the ";" character as a 'comment' token. It

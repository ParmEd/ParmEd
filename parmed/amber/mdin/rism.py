...
class rism:
    ...
    def __init__(self):
        self.sander = {'closure': ["kh"], 'noasympcorr': 1, 'buffer': 14.0, 'solvcut': -1.0,
                       ...
                       'treedcforder': 2, 'treetcforder': 2, 'treecoulomborder': 2, 'treedcfn0': 500,
                       'treetcfn0': 500, 'treecoulombn0': 500, 'mdiis_del': 0.7, 'mdiis_nvec': 5,
                       'mdiis_restart': 10.0, 'maxstep': 10000, 'npropagate': 5, 'polardecomp': 0,
                       'entropicdecomp': 0, 'verbose': 0, 'gfcorrection': 0, 'pcpluscorrection': 0}
